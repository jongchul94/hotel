    ...
    <div class="row ">
      <div class="col-lg-12 text-center">
          <div class="page-breadcumb py-2">
            ...
            <a href="contact.action" class="text-white">Contact Us</a>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-7 col-sm-12">
                <form action="mailSending.action" method="post">
                    <div class="row">
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <textarea name="userMessage" class="form-control" rows="6" placeholder="메시지를 남겨주세요"></textarea>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-5">
                <h3 class="mt-4 mt-lg-0 mb-3">지도에서 찾기</h3>
...
<section class="footer-btm secondary-bg py-4" >
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDytIDYWrCJUooGjnoyYaG16JQ-UAhUR64&callback=initMap"></script>    
