  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
          <h1 class="text-white py-100">회원정보(Admin)</h1>
      </div>
    </div>
  </div>
    ...
    <div class="row ">
      <div class="col-lg-12 text-center">
          <div class="page-breadcumb py-2">
            ...
            <a href="userAdmin.action" class="text-white">회원정보(Admin)</a>
        </div>
      </div>
    </div>
  </div>
            ...
            <div class="col-lg-8 text-center">
                <div class="block">
                    <div class="section-title">
                        <p class="section-subtitle">User Information</p>
                        <h2 class="mb-3">회원정보(Admin)</h2>
        ...
        <div class="border payment-confirm position-relative">
	          <div class="row justify-content-center align-items-center ">
	            <div class="col-md-12 col-sm-12 col-12 col-lg-4 mb-4 mb-lg-0">
	            	<img src="/hotel/resources/images/user.jpg" class="rounded-circle w-100" alt="confirm img"/>
	          	</div>
	                ...
	                <div class="row ">
	                    <div class="col-lg-6 col-md-6 col-sm-6">
	                        <div class="ed-cinfirm-detail">
	                          ...
	                          <a href="userDelete.action?userId=${dto.userId }" class="btn btn-main">강제탈퇴</a>
	                        </div>
	                    </div>
	                </div>
	              </div>
