    ...
    <div class="row ">
      <div class="col-lg-12 text-center">
          <div class="page-breadcumb py-2">
            ...
            <a href="searchPwd.action" class="text-white">Search Password</a>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12 col-sm-12" style="text-align: center;">
                ...
                <form action=""  name="loginForm" method="post">
                    ...
                    <button type="button" class="btn btn-main" onclick="location.href='login.action';">로그인</button>
                    <button type="button" class="btn btn-main" onclick="sendIt();">비밀번호 찾기</button>
                </form>
            </div>
